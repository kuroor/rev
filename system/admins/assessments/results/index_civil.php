...
<button type="button" class="btn btn-default"><a href="index_civil.php" >Architect RESULT</a></li></button>
...
<center>Bulacan State University <br>
College of Architecture and Fine arts<br>
ARCHITECT RESULT </center>
...
<?php 
 ...
 $stmt = $conn->prepare("SELECT * FROM  examproper WHERE user_id = '$user_id' and test_desc = 'Architect'");
 $stmt->execute();
